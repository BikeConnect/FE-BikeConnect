...
const DeactiveOwner = () => {
  ...
  const handleStatusUpdate = async (ownerId, newStatus) => {
    try {
      ...
      //   fetchActiveOwners(); // Refresh danh sách
          ...
          <tbody className="bg-white divide-y divide-gray-200">
            {owners.map((owner, index) => (
              ...
              >
                ...
                <td className="px-6 py-4 whitespace-nowrap">
                  <span className="px-3 py-1 inline-flex text-xs leading-5 font-semibold rounded-full bg-red-500 text-white">
                    Đã Khóa
                  </span>
                </td>
                <td className="px-6 py-4 whitespace-nowrap">
