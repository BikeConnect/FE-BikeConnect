  ...
  return (
    <footer className="footer">
      <div className="container">
        <div className="footer-section footer-logo-email">
          <figure className="footer-figure-logo">
            <img src={logo} alt="Bike Connect Logo" className="logo-footer" />
          </figure>
          <div className="footer-email">
            <p className="mt-4">
              Đăng kí email để có thể nhận thông tin về thuê xe từ chúng tôi
            </p>
